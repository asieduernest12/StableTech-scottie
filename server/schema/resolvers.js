  ...
  Mutation: {
    ...
    updateSchedule: async (parent, args) => {
      return Schedule.findByIdAndUpdate(
        { _id: args._id },
        {
          visitDay: args.visitDay,
          visitMonth: args.visitMonth,
          visitYear: args.visitYear,
    ...
    updateHorse: async (parent, args) => {
      return Horse.findByIdAndUpdate(
        { _id: args._id },
        {
          horseName: args.horseName,
          ownerName: args.ownerName,
          ...
          feed: args.feed,
          vaccineDate: args.vaccineDate,
          shoeDate: args.shoeDate,
          barName: args.barnName,
        }
      );
    },
